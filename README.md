...
IF YOU WANT TO MAKE STANDALONE (RUN AS EXE) AND MORE FASTER YOU CAN USE NUITKA TO COMPILE CODE INTO C AFTER ITS WILL BUILD YOUR CODE INTO EXE FILE or YOU CAN JUST DOWNLOAD INSTALLER FROM [RELEASES](https://github.com/sachinsenal0x64/FIXARR/releases) SECTION
